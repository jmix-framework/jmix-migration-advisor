...
public class UiComponentIssuesRegistry {
    ...
    protected static Map<String, UiComponentIssue> createRegistry() {
        ...
        return Stream.of(
                ...
                new UiComponentIssue("groupTable", CHANGED, "Add Jmix add-on 'Grouping Data Grid' and use 'groupDataGrid' component (available since Jmix 3.0)", 3),
                ...
                new UiComponentIssue("popupView", ABSENT, "Use 'dialog' with custom layout (https://docs.jmix.io/jmix/flow-ui/dialogs.html). Since Jmix 3.0, 'sideDialog' and 'sidePanelLayout' are additional alternatives", 5),
                ...
                new UiComponentIssue("slider", ABSENT, "Use HTML 'rangeInput' (available since Jmix 3.0) for a basic range input, or create a custom component using a 3rd-party JS library for a full-featured slider (https://demo.jmix.io/ui-samples/sample/custom-component-js-library)", 3),
