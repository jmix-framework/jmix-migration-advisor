...
public class UiComponentIssuesRegistry {
    ...
    protected static Map<String, UiComponentIssue> createRegistry() {
        ...
        return Stream.of(
                ...
                new UiComponentIssue("bulkEditor", CHANGED, "BulkEditor component is legacy. Add Jmix add-on 'Bulk Editor' and use the 'bulked_edit' action (https://docs.jmix.io/jmix/bulk-edit/index.html)", 3),
                ...
                new UiComponentIssue("embedded", CHANGED, "Use 'image' for images (https://docs.jmix.io/jmix/flow-ui/vc/html-components/image.html), html 'iframe' for embedded web pages, or 'htmlObject' for embedded objects", 2),
                new UiComponentIssue("fieldGroup", CHANGED, "Use 'formLayout'", 2),
                new UiComponentIssue("fileMultiUploadField", CHANGED, "Use 'upload' with 'MULTI_FILE_*' receiver type (https://docs.jmix.io/jmix/flow-ui/vc/components/upload.html)", 2),
                ...
                new UiComponentIssue("searchPickerField", CHANGED, "Use 'entityComboBox' with nested 'itemsQuery' for query-driven lazy search (also supports picker actions); use 'comboBox' + 'itemsQuery' for non-entity values (https://docs.jmix.io/jmix/flow-ui/vc/components/entityComboBox.html)", 2),
                ...
                new UiComponentIssue("suggestionPickerField", CHANGED, "Use 'entityComboBox' with nested 'itemsQuery' for search-as-you-type entity selection with picker actions (https://docs.jmix.io/jmix/flow-ui/vc/components/entityComboBox.html)", 2),
                new UiComponentIssue("tokenList", HAS_ALTERNATIVE, "Use 'multiSelectComboBox' (chips), 'multiSelectComboBoxPicker' (with action buttons) or 'multiValuePicker'. Not a 1:1 token control — labels/wrapping differ, treat as an alternative (https://docs.jmix.io/jmix/flow-ui/vc/components/multiSelectComboBox.html)", 2),
                ...
                new UiComponentIssue("frame", CHANGED, "Use 'fragment' (https://docs.jmix.io/jmix/flow-ui/fragments/fragments.html)", 5),
                new UiComponentIssue("grid", CHANGED, "Use 'gridLayout' for a 2D grid (https://docs.jmix.io/jmix/flow-ui/vc/layouts/gridLayout.html), or 'formLayout' for a form-like layout", 2),
