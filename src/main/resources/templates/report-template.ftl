...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  details.fold > summary h2::after { content: "▾"; font-size: .9em; color: var(--ink-soft);
  ...
  /* drill-down (not the section folds: those style their own chevron via summary h2::after) */
  details { margin-top: 6px; }
  details > summary { cursor: pointer; color: var(--accent); font-size: .82rem; list-style: none; }
  details > summary::-webkit-details-marker { display: none; }
  details:not(.fold) > summary::before { content: "▸ "; }
  details[open]:not(.fold) > summary::before { content: "▾ "; }
  details.fold { margin-top: 0; }
  details.fold > summary { color: inherit; font-size: inherit; }
  ...
  nav.toc .toc-action { font: inherit; font-size: .8rem; color: var(--ink-soft); background: var(--surface);
                        border: 1px solid var(--border); border-radius: 7px; padding: 6px 10px;
                        cursor: pointer; text-align: left; margin-top: 12px; }
  nav.toc .toc-action:hover { color: var(--ink); background: var(--surface-2); }
...
<div class="layout">
  <nav class="toc">
    ...
    <button type="button" id="toggle-all" class="toc-action">Expand all details</button>
  </nav>
